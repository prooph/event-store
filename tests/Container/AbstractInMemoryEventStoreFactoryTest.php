...
abstract class AbstractInMemoryEventStoreFactoryTest extends TestCase
{
    abstract protected function getEventStoreClassName(): string;

    abstract protected function getActionEventEmitterDecoratorClassName(): string;

    abstract protected function createEventStoreFactoryInstance(): AbstractInMemoryEventStoreFactory;

    abstract protected function createFromFactoryViaCallStatic(string $type, $container): EventStore;
