...
abstract class AbstractTransactionalActionEventEmitterEventStore extends AbstractActionEventEmitterEventStore implements
    TransactionalActionEventEmitterEventStore
{
    /**
     * @var bool
     */
